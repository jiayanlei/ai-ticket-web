...
const menuSeeds: MenuItem[] = [
  ...
  createMenuItem({
    id: 'm-knowledge-document',
    parentId: 'm-knowledge',
    menuName: '文档中心',
    menuType: 'MENU',
    path: '/knowledge/document',
    component: 'knowledge/documents/index',
    perms: 'knowledge:document:center',
    icon: 'profile',
    sortOrder: 3,
  }),
  createMenuItem({
    id: 'm-knowledge-graph',
    parentId: 'm-knowledge',
    menuName: '知识图谱',
    menuType: 'MENU',
    path: '/knowledge/graph',
    component: 'knowledge/graph/index',
    perms: 'knowledge:graph:view',
    icon: 'apartment',
    sortOrder: 4,
  }),
  createMenuItem({
  ...
  createMenuItem({
    id: 'm-knowledge-culture',
    parentId: 'm-knowledge',
    menuName: '企业文化',
    menuType: 'MENU',
    path: '/knowledge/culture',
    component: 'culture/company/index',
    perms: 'culture:article:view',
    icon: 'read',
    sortOrder: 6,
  }),
