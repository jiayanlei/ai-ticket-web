...
const metrics = [
  { label: '高价值客户', value: '214', hint: '本租户' },
  { label: '风险账户', value: '14', hint: '需回访' },
  { label: '未结互动', value: '36', hint: '跨渠道' },
  { label: '下一步建议', value: '22', hint: 'AI 生成' },
];
const statusOptions = [
  { label: '待处理', value: '待处理' },
  { label: '处理中', value: '处理中' },
