...
const pageDescription = '跟踪坐席指标、团队对比、处理量、首响、解决率、满意度、质检分和趋势。';
const primaryAction = '打开看板';
const metrics = [
  { label: '目标达成', value: '91%', hint: '本月' },
  { label: '平均处理', value: '7.8 分', hint: '较昨日 -0.4' },
  { label: '满意度', value: '94%', hint: '高于目标' },
  { label: '辅导机会', value: '11', hint: '待跟进' },
];
const statusOptions = [
  { label: '待处理', value: '待处理' },
  { label: '处理中', value: '处理中' },
...
const formState = reactive<BusinessRecordPayload>({
  ...
  aiSuggestion: '绩效中心已生成 AI 建议，请优先处理高风险记录。',
  tags: [pageTitle],
});
