...
const moduleName = 'ai-agents';
const pageTitle = 'AI 坐席中心';
const pageDescription = '配置 AI 坐席、启停状态、能力范围、渠道绑定、接管规则、表现指标和人工兜底。';
const primaryAction = '发布坐席';
const metrics = [
  { label: 'AI 坐席', value: '16', hint: '启用中' },
  { label: '工具调用', value: '947', hint: '今日' },
  { label: '策略拦截', value: '32', hint: '高风险' },
  { label: '自动化率', value: '64%', hint: '较上周 +5%' },
];
const statusOptions = [
  { label: '待处理', value: '待处理' },
  { label: '处理中', value: '处理中' },
...
const formState = reactive<BusinessRecordPayload>({
  ...
  aiSuggestion: 'AI 坐席中心已生成 AI 建议，请优先处理高风险记录。',
  tags: [pageTitle],
});
