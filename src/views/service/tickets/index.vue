...
const metrics = [
  { label: '未结工单', value: '128', hint: '较昨日 +12' },
  { label: 'SLA 风险', value: '18', hint: '剩余 30 分钟内' },
  { label: 'AI 建议', value: '32', hint: '可直接应用' },
  { label: '待确认', value: '9', hint: '等待客户反馈' },
];
const statusOptions = [
  { label: '待处理', value: '待处理' },
  { label: '处理中', value: '处理中' },
