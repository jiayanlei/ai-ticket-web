...
const metrics = [
  { label: '开放应用', value: '26', hint: '启用' },
  { label: 'API 调用', value: '12.8k', hint: '今日' },
  { label: 'Webhook 失败', value: '16', hint: '待重试' },
  { label: '配额风险', value: '3', hint: '接近上限' },
];
const statusOptions = [
  { label: '待处理', value: '待处理' },
  { label: '处理中', value: '处理中' },
