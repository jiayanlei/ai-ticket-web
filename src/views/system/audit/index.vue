...
const metrics = [
  { label: '审计日志', value: '12.8k', hint: '本周' },
  { label: '敏感操作', value: '8', hint: '需复核' },
  { label: '导出记录', value: '31', hint: '今日' },
  { label: '异常会话', value: '4', hint: '高风险' },
];
const statusOptions = [
  { label: '待处理', value: '待处理' },
  { label: '处理中', value: '处理中' },
