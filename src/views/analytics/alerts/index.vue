...
const metrics = [
  { label: '未处理告警', value: '23', hint: '待认领' },
  { label: '严重告警', value: '5', hint: '需立即处理' },
  { label: '静默规则', value: '12', hint: '生效' },
  { label: '平均恢复', value: '18 分钟', hint: '本周' },
];
const statusOptions = [
  { label: '待处理', value: '待处理' },
  { label: '处理中', value: '处理中' },
