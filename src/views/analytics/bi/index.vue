...
const metrics = [
  { label: '报表数量', value: '42', hint: '已发布' },
  { label: '订阅任务', value: '18', hint: '运行中' },
  { label: '口径冲突', value: '3', hint: '待确认' },
  { label: '导出请求', value: '27', hint: '今日' },
];
const statusOptions = [
  { label: '待处理', value: '待处理' },
  { label: '处理中', value: '处理中' },
