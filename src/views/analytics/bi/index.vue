...
const moduleName = 'analytics-bi';
const pageTitle = 'BI 报表';
const pageDescription = '管理报表目录、自定义筛选、图表配置、导出、订阅任务和指标口径说明。';
const primaryAction = '新建报表';
const statusOptions = [
  { label: '待处理', value: '待处理' },
  { label: '处理中', value: '处理中' },
  { label: '待审核', value: '待审核' },
...
const formState = reactive<BusinessRecordPayload>({
  ...
  aiSuggestion: 'BI 报表已生成 AI 建议，请优先处理高风险记录。',
  tags: [pageTitle],
});
