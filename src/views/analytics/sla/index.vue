...
const moduleName = 'analytics-sla';
const pageTitle = 'SLA 管理';
const pageDescription = '管理 SLA 策略、等级规则、倒计时、超时预警、违约统计和补救动作。';
const primaryAction = '发布策略';
const metrics = [
  { label: 'SLA 策略', value: '24', hint: '生效' },
  { label: '即将超时', value: '18', hint: '30 分钟内' },
  { label: '已超时', value: '6', hint: '需补救' },
  { label: '履约率', value: '90.1%', hint: '本周' },
];
const statusOptions = [
  { label: '待处理', value: '待处理' },
  { label: '处理中', value: '处理中' },
...
const formState = reactive<BusinessRecordPayload>({
  ...
  aiSuggestion: 'SLA 管理已生成 AI 建议，请优先处理高风险记录。',
  tags: [pageTitle],
});
