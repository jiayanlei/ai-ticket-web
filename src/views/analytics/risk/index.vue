...
const metrics = [
  { label: '风险事件', value: '32', hint: '今日' },
  { label: '高危账户', value: '11', hint: '需处理' },
  { label: '合规告警', value: '7', hint: '待确认' },
  { label: '处置建议', value: '18', hint: 'AI 生成' },
];
const statusOptions = [
  { label: '待处理', value: '待处理' },
  { label: '处理中', value: '处理中' },
