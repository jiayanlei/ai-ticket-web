...
const moduleName = 'analytics-operations';
const pageTitle = '运营分析';
const pageDescription = '分析服务量、渠道趋势、团队负载、处理效率、SLA 趋势和异常维度钻取。';
const primaryAction = '打开看板';
const metrics = [
  { label: '服务量', value: '12.8k', hint: '今日' },
  { label: '效率指数', value: '91', hint: '综合' },
  { label: 'SLA 趋势', value: '-6.3%', hint: '需关注' },
  { label: '异常维度', value: '5', hint: '待钻取' },
];
const statusOptions = [
  { label: '待处理', value: '待处理' },
  { label: '处理中', value: '处理中' },
...
const formState = reactive<BusinessRecordPayload>({
  ...
  aiSuggestion: '运营分析已生成 AI 建议，请优先处理高风险记录。',
  tags: [pageTitle],
});
